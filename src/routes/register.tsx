      ...
      <main className="relative flex flex-1 items-center justify-center px-4 pb-16 pt-32">
        ...
        <div className="glass relative w-full max-w-md rounded-2xl p-8">
          ...
          >
            ...
            <button
              type="submit"
              className="mt-2 rounded-lg bg-brand-gradient py-3 font-semibold text-brand-foreground transition hover:-translate-y-0.5 hover:shadow-[0_0_15px_var(--cyan)] glow-hover"
            >
              Create Account
            </button>
          </form>
