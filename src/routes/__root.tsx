...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", href: "/favicon.svg?v=snapcut", type: "image/svg+xml" },
      { rel: "icon", href: "/favicon.ico?v=snapcut", sizes: "32x32", type: "image/x-icon" },
      { rel: "apple-touch-icon", href: "/apple-touch-icon.png?v=snapcut" },
    ],
  }),
